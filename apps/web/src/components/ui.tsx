...
export function Button(
  ...
  const base =
    'inline-flex items-center justify-center gap-2 rounded-xl text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-bg-950 focus:ring-accent-500/60 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md'
  ...
  const variants = {
    ...
    secondary: 'bg-surface-700 text-white hover:bg-surface-600 border border-white/10'
  }
